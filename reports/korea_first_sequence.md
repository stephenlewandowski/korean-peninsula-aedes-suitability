# Korea-first implementation sequence

This record translates the approved follow-on applications into reviewable
gates while keeping the Korean Peninsula primary.

| Gate | Deliverable | Current state |
| --- | --- | --- |
...
Japan is rehomed as the separate IDEA-0007 comparator. The KDCA and Goyang
Anopheles leads are rehomed as IDEA-0008 and are not used as Aedes validation.

No gate authorizes a disease forecast, individual-risk estimate, installation-
level map, or operational early-warning product. North Korea remains a modeled
extrapolation region unless direct public DPRK observations are secured.
